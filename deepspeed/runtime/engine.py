...
class DeepSpeedEngine(Module):
    ...
    def __init__(
        ...
        self.fp16_supported = get_accelerator().is_fp16_supported() if get_accelerator().device_name(
        ) == "hpu" else True
    ...
    def _load_checkpoint(self,
        ...
        if load_module_only:
            ...
            if load_optimizer_states and self.optimizer is not None and has_zero_optimizer_state:
